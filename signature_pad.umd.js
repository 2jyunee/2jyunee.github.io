(function (global, factory) {
  ...
  class SignaturePad extends SignatureEventTarget {
    ...
    _calculateCurveWidths(startPoint, endPoint) {
      if (this.usePressure) {
        ...
        const velocity =
          ...
          console.log("pressure", endPoint.pressure, "pressure_org17", pressure_org, "pressure_cur17", pressure_cur);
    ...
    _strokeWidth(velocity) {
      return Math.max((this.maxWidth / (velocity + 1)) * 0.5, this.minWidth);
    }
