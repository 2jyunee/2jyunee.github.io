(function (global, factory) {
  ...
  class SignaturePad extends SignatureEventTarget {
    ...
    _calculateCurveWidths(startPoint, endPoint) {
      if (this.usePressure) {
        ...
        const velocity =
          ...
          console.log("pressure", endPoint.pressure, "pressure_org18", pressure_org, "pressure_cur18", pressure_cur);
    ...
    _strokeWidth(velocity) {
      return Math.max((this.maxWidth / (velocity + 1)) * 0.3, this.minWidth);
    }
